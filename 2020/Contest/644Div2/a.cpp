...
bool psbl(int r,int g, int b, int w){
	int t = r+g+b+w;
	if(r<0 || g<0 || b<0 || w<0) return false;
	if( t%2 ==0 && r%2 ==0 && g%2 ==0 && b%2 ==0 && w%2 ==0) return true;
	if( t%2 && (r%2 + g%2 + b%2 + w%2)==1 ) return true;
	else return false;
}
...
if( psbl(r,g,b,w)
	||
	psbl(r-1,g-1,b-1,w+3)
	||
	psbl(r-2,g-2,b-2,w+6)
