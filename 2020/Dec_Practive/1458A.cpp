...
2) gcd(a1, a2, a3, ... an) = gcd(a1, a2 - a1, a3, ... an)

3) gcd(a1, a2, a3, ... an) = gcd(a1, a2 - a1, a3 - a1, ... an - a1)

4) gcd(a, 0) = a;
*/

int i_min = min_element(a.begin(), a.end()) - a.begin();
int g = 0;
fr(i,0,n) {
g = __gcd(a[i]-a[i_min], g);
}

fr(j,0,m){

	p1(__gcd(a[i_min]+b[j], g));
}
