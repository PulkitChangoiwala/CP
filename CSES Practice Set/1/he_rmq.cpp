...
public:
	...
	int query(int l, int r){ //Query on [l,r)
		int ans;
		ans = operation == 0 ? 0 : seg_tree[l+n];
		for(l+=n,r+=n; l<r; l >>= 1, r >>=1){
			...
			if(operation == 0) {
				...
				if(l&1) {ans = array[seg_tree[l]] < array[ans] ? seg_tree[l] : ans; l++;}
				if(r&1) {--r; ans = array[seg_tree[r]] < array[ans] ? seg_tree[r] : ans; }
			}
			else if(operation == 2){
				if(l&1) {ans = array[seg_tree[l]] > array[ans] ? seg_tree[l] : ans; l++;}
				if(r&1) {--r; ans = array[seg_tree[r]] > array[ans] ? seg_tree[r] : ans; }
