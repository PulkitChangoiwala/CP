...
fr(i,0,k){
	...
	if(i+1<k && i-2 >=0 && (tmp[i] == tmp[i+1]) && (tmp[i-2] != tmp[i])) { ans += 2; i++;}
	else if(i+1<k && i-2 >=0 && i-3 >=0 && (tmp[i] == tmp[i+1]) && (tmp[i-2] == tmp[i] && tmp[i-3] != tmp[i])) {ans+=2; i++;}
	else if(i+1<k && i-2 >=0 && i-3 >=0 && (tmp[i] == tmp[i+1]) && (tmp[i-2] == tmp[i] && tmp[i-3] == tmp[i])) {ans++; i++;}
	else if(i+1<k && i==0 && (tmp[i] == tmp[i+1])) { ans += 2; i++;}	
	else	
		ans++;

	//if(i+1<k && i-2 >=0 && i-3 >=0 && (tmp[i] == tmp[i+1]) && (tmp[i-2] == tmp[i] && tmp[i-3] == tmp[i])) {ans--;}
