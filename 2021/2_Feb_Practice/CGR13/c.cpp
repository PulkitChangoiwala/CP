...
/*
Let P stores the starting indices of all the passes.
Then any permutation of P will be a valid answer
(Can be proved)

Consider non decreasing permutation of P, denote it also by P

Then simulate the algorithm with first i, such that s[i] != 1
...
for(int i=0;i<n;++i){
	...
	if(i+1< n) cnt[i+1] += cnt[i] - (s[i]-1); // putting extra Pekora on next trampoline
