...
void solve(){ 
	...
	//make a 26*26 table of minimum number of changes required 
	//for change ith character to jth, with given changes
	//apply floyad warshall?
	floyad_warshall(26, -1, dis);
