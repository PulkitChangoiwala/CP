...
void solve(){ 
int n;
double x0,y0, xn2,yn2,x1,y1,xc,yc;
cin>>n>>x0>>y0>>xn2>>yn2;
xc = (x0+xn2)/2.0, yc = (y0+yn2)/2.0;

double ang_rad = (2*M_PI/n);
double dx = xc-x0;
double dy = y0-yc;

x1 = xc - (dx*cos(ang_rad)  + dy*sin(ang_rad));
y1 = -dx*sin(ang_rad) + dy*cos(ang_rad) + yc;
