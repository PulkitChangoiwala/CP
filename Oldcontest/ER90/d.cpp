...
/*
logic 1:
sub array is even length.
A sub array of 2*x length contribute as same as x subarray of length 2

*/
v(int) odd; //sub array start at odd position
v(int) even; //sub array start at even position
fr(i,0,n-1){
...
//using kadane algo find max sum of subarray among odd and even array;
//debug_arr(even);
//debug_arr(odd);
int x,y;
x=y=even[0];
